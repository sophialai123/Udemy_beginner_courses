...
#TODO 1. make a compare A list
#TODO 2. make a compare B list
#TODO 3. Ask the user to choose : Compare A and B
#TODO 4. If the answer is right, continue the game and print out the current score,
# Compare previous value to a new value,continue the game and add a new score.
#TODO 5. If the answer is wrong, end the game and print out the current score.
...
while True:
    ...
    print(f" Compare A has {a_followers} followers.")
    print(f" Against B has {b_followers} followers.")
...
"""
solution steps (breakdown a project into small problems)
1. display art
...
def check_answers(guess, a_followers, b_followers):
    if a_followers > b_followers:
        return guess == "a"  # if guess == "a", it will return True, otherwise, return False.
    else:
        return guess == "b"
